...
import { X, BarChart3, Target, CheckCircle, Flame, Trophy } from 'lucide-react';
import { useTaskStore } from '@/store/useTaskStore';
import { useTheme } from '@/hooks/useTheme';

interface ProgressPanelSwipeProps {
  onClose: () => void;
}

const ProgressPanelSwipe: React.FC<ProgressPanelSwipeProps> = ({ onClose }) => {
...
export default ProgressPanelSwipe;