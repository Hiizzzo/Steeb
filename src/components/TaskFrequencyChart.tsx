  ...
  return (
    ...
    style={{
      ...
      <div className={`text-center mb-6 pt-2 pb-2 -mx-2 -my-2 ${
        isShiny ? 'bg-black' : 'bg-black'
      }`}
      style={{ backgroundColor: isDark ? '#FFFFFF' : '#000000' }}>
        <h2 style={{ color: isDark ? '#000000' : '#FFFFFF' }} className="text-xl font-bold mb-2">
          Tipo de tareas más completadas
        </h2>
        <p style={{ color: isDark ? '#000000' : '#FFFFFF' }} className="text-sm">
      ...
      style={{ border: isDark ? '3px solid #FFFFFF' : '3px solid #000000' }}>
        <div className={`w-full h-16 flex rounded-lg ${
