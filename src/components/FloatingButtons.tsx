      ...
      <div className="fixed bottom-8 left-0 right-0 z-50 pointer-events-none no-select">
        <div className="flex items-center justify-center px-8 pointer-events-none no-select">
          ...
          <motion.button
            ...
            className="w-16 h-16 sm:w-20 sm:h-20 rounded-full shadow-2xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-[0_20px_40px_rgba(0,0,0,0.3)] active:scale-95 hover:-translate-y-1 bg-white dark:!bg-white pointer-events-auto touch-button no-select"
            style={{ 
              touchAction: 'none',
              userSelect: 'none',
            ...
            <AnimatePresence mode="wait">
              {isLongPressed && showCalendar ? (
                <motion.div
                  ...
                  className="relative"
                >
                  <Calendar size={28} className="text-black dark:!text-black sm:w-8 sm:h-8" strokeWidth={3} />
                  {/* Indicador de "mantener presionado" */}
                  <motion.div
                    animate={{ scale: [1, 1.2, 1] }}
                    transition={{ duration: 1, repeat: Infinity }}
                    className="absolute -top-1 -right-1 w-3 h-3 bg-yellow-400 rounded-full border-2 border-black dark:border-black"
                  />
                </motion.div>
              ) : isLongPressed ? (
                <motion.div
                ...
                >
                  <div className="w-1.5 h-1.5 bg-black dark:!bg-black rounded-full animate-bounce" style={{ animationDuration: '0.3s', animationDelay: '0s' }}></div>
                  <div className="w-1.5 h-1.5 bg-black dark:!bg-black rounded-full animate-bounce" style={{ animationDuration: '0.3s', animationDelay: '0.1s' }}></div>
                  <div className="w-1.5 h-1.5 bg-black dark:!bg-black rounded-full animate-bounce" style={{ animationDuration: '0.3s', animationDelay: '0.2s' }}></div>
                </motion.div>
              ) : (
                <motion.div
                  key="plus"
                  ...
                  transition={{ duration: 0.2, ease: 'easeOut' }}
                >
                  <Plus size={28} className="text-black dark:!text-black sm:w-8 sm:h-8" strokeWidth={3} />
                </motion.div>
              )}
            </AnimatePresence>
          </motion.button>
            ...
            >
              ...
              <div className="relative w-[0px] h-[0px]">
                ...
                <button
                  ...
                  className="absolute -top-[120px] -left-[48px] w-24 h-24 rounded-full border-2 border-black bg-white dark:border-white dark:bg-black flex flex-col items-center justify-center"
                >
                  <Calendar size={28} className="text-black dark:text-white" />
                  <span className="mt-1 text-xs font-semibold text-black dark:text-white">Calendario</span>
                </button>
                ...
                <button
                  ...
                  className="absolute -right-[120px] -top-[48px] w-24 h-24 rounded-full border-2 border-black bg-white dark:border-white dark:bg-black flex flex-col items-center justify-center"
                >
                  <BarChart2 size={28} className="text-black dark:text-white" />
                  <span className="mt-1 text-xs font-semibold text-black dark:text-white">Estadísticas</span>
                </button>
                ...
                <button
                  ...
                  className="absolute -left-[120px] -top-[48px] w-24 h-24 rounded-full border-2 border-black bg-white dark:border-white dark:bg-black flex flex-col items-center justify-center"
                >
                  <MessageCircle size={28} className="text-black dark:text-white" />
                  <span className="mt-1 text-xs font-semibold text-black dark:text-white">Chat con Stebe</span>
                </button>
